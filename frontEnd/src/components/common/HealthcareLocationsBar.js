...
import { FiMapPin, FiPackage, FiChevronDown, FiChevronUp, FiX, FiHome } from 'react-icons/fi';
      ...
      <div className="flex items-center justify-between px-4 py-2">
        <div className="flex items-center">
          <div className="mr-2 p-1.5 rounded-full bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400">
            {activeTab === 'pharmacies' ? <FiPackage className="h-4 w-4" /> : <FiHome className="h-4 w-4" />}
          </div>
          <div>
