...
const PrescriptionManagement = () => {
    return (
        <div className="p-6 bg-white rounded-lg shadow-md">
            ...
            <form>
                <input type="text" placeholder="Patient Name" className="border p-2 mb-4 w-full" required />
                <input type="text" placeholder="Medication" className="border p-2 mb-4 w-full" required />
